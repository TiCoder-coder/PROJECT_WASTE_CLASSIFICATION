...
var fs = require('fs');
var _stylexExtendBabelPlugin = require('@stylex-extend/babel-plugin');
...
class PluginContext {
    get filter() {
        return pluginutils.createFilter(_class_private_field_get(this, _pluginOptions).include, _class_private_field_get(this, _pluginOptions).exclude);
    }
...
function extend(ctx) {
    const filter = pluginutils.createFilter(/\.[jt]sx?$/, []);
    return {
        name: 'stylex-extend',
        buildStart () {
            ctx.globalStyles = {};
